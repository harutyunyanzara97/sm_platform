const { Plans, Plan_Features } = require('../models/index');
...
module.exports = class extends BaseService {
  ...
  async updatePlanFeature(req) {
    try {
      ...
      const { param_name, param_type, param_description, param_limit, param_alert_level, param_flag, plan_id, id } = req.body;
